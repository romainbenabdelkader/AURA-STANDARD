...
- `CHECK` = short checksum (Base32) derived from truncated SHA3-256
...
- CHECK provides structural integrity and basic collision detection, **not** cryptographic security.
